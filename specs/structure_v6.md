...
|        Тип         |                 Имя                  |                                                                                                                                                                                                                                                     Описание                                                                                                                                                                                                                                                     |            Длина (В байтах)            |
| :----------------: | :----------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------: |
|      vec3_i16      |               Позиция                |                                               Позиция блока относительно рута. Каждый компонент закодирован по следующей формуле: `(преобразование в 16-и битное знаковое число) ( ([исходный компонент позиции блока] - [компонент центра границ рута]) / [компонент размера границ рута] )` и по следующей формуле каждый компонент декодируется: `[закодированный компонент позиции блока] * [компонент размера границ рута] + [компонент центра границ рута]`                                                |                   6                    |
...
%% Благодарность к RuslaNHL за первые два столбца %%
...
%% Спецификация разработана Onran'ом на основе предоставленного кода от XMAKE и небольших экспериментов, проведённых в игре %%